...
(define (domain VGDLGame)  
	...
	(:types
		...
		avatar - MovingAvatar
		wall - Immovable
		MovingAvatar Resource Immovable Passive - Object
	)
	...
	(:action CRATE_AVATAR_BOUNCEFORWARD_UP
		...
		:precondition (and
						...
						(not (is-greendoor ?x ?new_y))
						(not (is-yellowdoor ?x ?new_y))
						(not (is-redkey ?x ?new_y))
						(not (is-yellowkey ?x ?new_y))
						(not (is-bluekey ?x ?new_y))
						(not (is-greenkey ?x ?new_y))
						(not (is-chip ?x ?new_y))
						(not (is-gate ?x ?new_y))
	...
	(:action CRATE_AVATAR_BOUNCEFORWARD_LEFT
		...
		:precondition (and
						...
						(not (is-greendoor ?new_x ?y))
						(not (is-yellowdoor ?new_x ?y))
						(not (is-redkey ?new_x ?y))
						(not (is-yellowkey ?new_x ?y))
						(not (is-bluekey ?new_x ?y))
						(not (is-greenkey ?new_x ?y))
						(not (is-chip ?new_x ?y))
						(not (is-gate ?new_x ?y))
